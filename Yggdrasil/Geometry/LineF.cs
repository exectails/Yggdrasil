namespace Yggdrasil.Geometry
{
	...
	public readonly struct LineF
	{
		...
		public LineF(Vector2F point1, Vector2F point2)
		{
			this.Point1 = point1;
			this.Point2 = point2;
		}
		...
		/// <returns></returns>
		public bool Intersects(LineF otherLine, out Vector2F intersection)
		{
			...
			intersection = new Vector2F((float)interX, (float)interY);
		...
		/// <returns></returns>
		public static bool operator ==(LineF val1, LineF val2)
		{
		...
		{
			return obj is LineF line && this == line;
		}
		...
		{
			return string.Format("(LineF - Point1: {0}/{1}, Point2: {2}/{3})", this.Point1.X, this.Point1.Y, this.Point2.X, this.Point2.Y);
		}
	}
}
