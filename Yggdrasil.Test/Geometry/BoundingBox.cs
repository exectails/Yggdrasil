...
namespace Yggdrasil.Test.Geometry
{
    public class BoundingBoxTests
    {
        ...
        public void Contains()
        {
            ...
            Assert.True(box.Contains(new Vector2(50, 50)));
            Assert.True(box.Contains(new Vector2(0, 0)));
            Assert.True(box.Contains(new Vector2(100, 100)));
            Assert.False(box.Contains(new Vector2(-1, -1)));
            Assert.False(box.Contains(new Vector2(101, 101)));
        }
        ...
        public void Intersects()
        {
            ...
            var box3 = new BoundingBox(100, 100, 100, 100);
            var box4 = new BoundingBox(101, 101, 100, 100);
