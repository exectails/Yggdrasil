namespace Yggdrasil.Variables.DefaultGetters
{
	...
	public static partial class VariableContainerExtensions
	{
		...
		/// different type.
		/// </exception>
		public static VariableContainer<TIdent>.UShortVariable UShort<TIdent>(this VariableContainer<TIdent> container, TIdent ident)
		{
			if (!container.TryGet<VariableContainer<TIdent>.UShortVariable>(ident, out var variable))
			{
				if (!container.AutoCreate)
					return null;

				variable = container.Create(new VariableContainer<TIdent>.UShortVariable(ident));
			}
		...
		/// different type.
		/// </exception>
		public static VariableContainer<TIdent>.UShortVariable UShort<TIdent>(this VariableContainer<TIdent> container, TIdent ident, ushort value)
		{
			if (!container.TryGet<VariableContainer<TIdent>.UShortVariable>(ident, out var variable))
				return container.Create(new VariableContainer<TIdent>.UShortVariable(ident, value));
