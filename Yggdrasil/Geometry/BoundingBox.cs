...
{
	/// <summary>
	/// An axis-aligned, integer-based bounding box, representing a
	...
	public readonly struct BoundingBox : IEquatable<BoundingBox>
	{
		...
		public BoundingBox(Vector2 pos, int width, int height)
		...
		/// <returns></returns>
		public static BoundingBox FromPoints(ReadOnlySpan<Vector2> points)
		{
			if (points.Length == 0)
				return Empty;
